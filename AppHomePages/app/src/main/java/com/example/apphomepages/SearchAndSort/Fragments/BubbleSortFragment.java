...
import com.example.apphomepages.SearchAndSort.DialogFragments.BubbleSortDialogFragment;
...
public class BubbleSortFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        Button generateButton = viewGlobal.findViewById(R.id.generateButtonBubble);
        Button startButton = viewGlobal.findViewById(R.id.startButtonBubble);
        Button stopButton = viewGlobal.findViewById(R.id.stopButtonBubble);
        Button rewindButton = viewGlobal.findViewById(R.id.rewindButtonBubble);
        ...
        instructionsButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                BubbleSortDialogFragment dialogFragment = new BubbleSortDialogFragment();
